...
public abstract class ConfigDurabilityLike extends Config {
    ...
    protected ConfigDurabilityLike(boolean enabled, OverlayDurabilityLike.Style style,
                                   DurabilityFormatter.Format textFormat, int numPadPosition, boolean showWhenFull,
                                   boolean showWhenEmpty,
                                   int color, ColorType colorType, double[] colorThreshold, int[] threeColors,
                                   boolean smoothBar, int barOffset,
    ...
    public void loadConfig() {
        ...
        barOffset = config
                .getInt("BarOffset", category() + ".StyleConfig.Bars", barOffset, 0, 16,
                        "Offset the bar by this amount");
